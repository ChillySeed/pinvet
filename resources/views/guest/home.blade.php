...
@section('title', 'PINVET - Sistem Peminjaman Inventaris')
...
@section('content')
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 hero-content">
                    ...
                    <!-- Quick Stats dihilangkan sesuai permintaan -->
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="step-card">
                        ...
                        <h4>Isi Formulir</h4>
                        <p class="text-muted">Lengkapi data peminjaman sesuai tipe (internal/eksternal).</p>
                        <div class="mt-3">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="step-card">
                        ...
                        <p class="text-muted">Sistem akan membuat surat peminjaman otomatis dalam PDF.</p>
                        <div class="mt-3">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="step-card">
                        ...
                        <h4>Ambil Barang</h4>
                        <p class="text-muted">Tunjukkan surat ke admin dan ambil barang di lokasi.</p>
                        <div class="mt-3">
    ...
    <!-- Modal lainnya bisa ditambahkan nanti -->
@endsection
...
<script>
    ...
    // Update cart count dari session (bisa via AJAX nanti)
    // Untuk sementara statis
</script>
@endpush