...
@section('title', 'Edit Barang - PINVET Admin')
    ...
    <div class="card-body">
        <form action="{{ route('admin.barang.update', $barang) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('pemilik_barang') is-invalid @enderror" id="pemilik_barang" name="pemilik_barang" value="{{ old('pemilik_barang', $barang->pemilik_barang) }}">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control @error('jumlah_total') is-invalid @enderror" id="jumlah_total" name="jumlah_total" value="{{ old('jumlah_total', $barang->jumlah_total) }}" min="0" required>
                    @error('jumlah_total')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control @error('jumlah_tersedia') is-invalid @enderror" id="jumlah_tersedia" name="jumlah_tersedia" value="{{ old('jumlah_tersedia', $barang->jumlah_tersedia) }}" min="0" required>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('deskripsi_barang') is-invalid @enderror" id="deskripsi_barang" name="deskripsi_barang" rows="3">{{ old('deskripsi_barang', $barang->deskripsi_barang) }}</textarea>
            ...
            <div class="mb-3">
                ...
                @if($barang->gambar_barang)
                    <div class="mb-2">
                        <img src="{{ asset('storage/'.$barang->gambar_barang) }}" width="100" alt="">
                    </div>
                @endif
            ...
            <div class="mb-3 form-check">
                <input type="checkbox" class="form-check-input" id="dapat_disewa" name="dapat_disewa" value="1" {{ old('dapat_disewa', $barang->dapat_disewa) ? 'checked' : '' }}>
                <label class="form-check-label" for="dapat_disewa">Dapat Disewakan</label>
            </div>

            <div class="mb-3" id="harga_sewa_field" style="display: {{ old('dapat_disewa', $barang->dapat_disewa) ? 'block' : 'none' }};">
                <label for="harga_sewa_per_hari" class="form-label">Harga Sewa per Hari (Rp)</label>
                <input type="number" class="form-control @error('harga_sewa_per_hari') is-invalid @enderror" id="harga_sewa_per_hari" name="harga_sewa_per_hari" value="{{ old('harga_sewa_per_hari', $barang->harga_sewa_per_hari) }}" min="0">
